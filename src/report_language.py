...
_OPERATION_ADVICE_TRANSLATIONS = {
    "strong_buy": {"zh": "強烈買入", "en": "Strong Buy"},
    "buy": {"zh": "買入", "en": "Buy"},
    "hold": {"zh": "持有", "en": "Hold"},
    "watch": {"zh": "觀望", "en": "Watch"},
    "reduce": {"zh": "減倉", "en": "Reduce"},
    "sell": {"zh": "賣出", "en": "Sell"},
    "strong_sell": {"zh": "強烈賣出", "en": "Strong Sell"},
}
...
_TREND_PREDICTION_TRANSLATIONS = {
    "strong_bullish": {"zh": "強烈看多", "en": "Strong Bullish"},
    "bullish": {"zh": "看多", "en": "Bullish"},
    "sideways": {"zh": "震盪", "en": "Sideways"},
    "bearish": {"zh": "看空", "en": "Bearish"},
    "strong_bearish": {"zh": "強烈看空", "en": "Strong Bearish"},
}
